...
// 3-In every iteration, we pop out the node ‘v’ and put it in the solution vector, as we are traversing this node.
// 4-All the unvisited adjacent nodes from ‘v’ are visited next and are pushed into the queue.
