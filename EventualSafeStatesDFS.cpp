...
// Case 2: If the adjacent node is visited and also on the same path(i.e marked visited in the pathVis array), 
// we will return true, because it means it has a cycle, thereby the pathVis was true.
